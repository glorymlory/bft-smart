...
// old version of PipelineManager
public class PipelineManager1_old {
    // only for the leader
    ...
    public PipelineManager1_old(int maxConsensusesInExec, int waitForNextConsensusTime, int bandwidthMibit, int maxBatchSize) {
